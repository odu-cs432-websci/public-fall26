# Homework 3 - Web Archiving
**Due:** Sunday, November 22, 2026 by 11:59pm  
...
* Install a stand-alone version of MemGator on your own machine, see <https://github.com/oduwsdl/MemGator/releases>
  * This was described in [EC-memgator](https://github.com/odu-cs432-websci/public-fall26/blob/main/getting-started/EC-memgator.md)
...
Notes:
* As described in [EC-memgator](https://github.com/odu-cs432-websci/public-fall26/blob/main/getting-started/EC-memgator.md), you **must** include the `-c` and `-a` options to specify your contact information and to use the alternate `archives.json` file.
...
### Q3. Analyze Datetimes of Mementos.
...
![hw4-scatterplot-example.png](hw3-scatterplot-example.png)
...
### Q4. Explore ArchiveWeb.page and ReplayWeb.Page

Install the free [ArchiveWeb.page](https://archiveweb.page/) browser extension (Webrecorder) and create a new session.  Archive at least 10 webpages related to a common topic that you find interesting. ArchiveWeb.page stores collections locally in your browser. To make your work accessible to others, download your collection as a WARC/WACZ file and upload it to a publicly shareable location (for example, Google Drive with sharing set to "Anyone with the link can view"). Include the share link to the exported archive in your report.
...
After creating your collection at ArchiveWeb.page, download the collection as a WARC file (see [Downloading Content](https://archiveweb.page/en/download/)).

Then load this WARC file into [ReplayWeb.page](https://replayweb.page), a tool from the Webrecorder Project (folks who developed ArchiveWeb.page).  From <https://webrecorder.net/tools>:
...
You should be working in the private GitHub repo that I created for you in the [odu-cs432-websci organization](https://github.com/odu-cs432-websci/) (your repo URL should look something like https<nolink>://github.com/odu-cs432-websci/fall26-*username*/). 
...
https<nolink>://github.com/odu-cs432-websci/fall26-*username*/blob/main/HW3-report.md
